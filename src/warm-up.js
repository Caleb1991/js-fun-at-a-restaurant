...
let vegetables = ['carrot', 'cauliflower', 'peas', 'corn', 'broccolli'];
...
// different fruits.
let fruits = ['strawbeebs', 'bluebeebs', 'pineapple', 'apple', 'cranbeebs', 'watermelon', 'peach'];
...
let groceryStore = { 'name': 'King Soopers', 'isOpen': true }
